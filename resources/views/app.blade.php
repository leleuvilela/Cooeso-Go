...
<head>
	...
	<title>Congresso de Oftalmologia da UFG</title>
...
<body>
	...
	<!-- sidebar panel -->
	<div class="content-header" ng-include="'build/views/common/header.html'"></div>
	<!-- /sidebar panel -->
	...
	@if(Config::get('app.debug'))
		...
		<script src="{{asset('build/js/controllers/boleto.js')}}" ></script>
